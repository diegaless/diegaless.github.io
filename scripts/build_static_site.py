...
PAGES = [
    ...
    Page(
        ...
        title='improveops.me | Conferencias',
    ...
    Page(
        ...
        title='improveops.me | Competiciones',
    ...
    Page(
        ...
        title='improveops.me | Excursiones',
    ...
    Page(
        path='404.html',
        body_id='page-404',
        title='improveops.me | 404 Not Found',
        description='Error 404: Signal Lost.',
        keywords='404, Error, improveops.me',
        og_type='website',
...
def write_pages() -> None:
    ...
    social_image_alt = 'Terminal-style social card for improveops.me'
